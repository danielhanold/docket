...
| `halted` | Stopped needing a human — fundamentally-invalidated design (Step 3) or a hard error. Committed on `metadata_branch` as a dated `## Run halted` section — see Step 3 for the write. | **stop + surface** |
