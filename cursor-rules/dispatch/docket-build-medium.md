## docket-build-medium — dispatch only
...
Dispatch to the subagent `docket-build-medium`, foreground, using this mode's subagent-launch
...
One concrete call, as an illustration of the shape — not the contract:
    ...
    Task(subagent_type: "docket-build-medium", run_in_background: false,
