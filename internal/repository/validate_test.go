...
func TestValidateSingleSnapshot(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name: "filename slug is a bare prefix of the frontmatter slug",
			docs: []InputDocument{record(t, KindChange, LocationActive, "docs/changes/active/0042-w.md",
				minimalChange(42, "widget", "proposed"))},
			code:     CodeChangeFilenameMismatch,
			severity: domain.SeverityError,
			field:    "path",
			entity:   changeEntity(42, "widget", "docs/changes/active/0042-w.md"),
		},
		{
			name: "filename carries no slug at all",
			docs: []InputDocument{record(t, KindChange, LocationActive, "docs/changes/active/0042-.md",
				minimalChange(42, "widget", "proposed"))},
			code:     CodeChangeFilenameMismatch,
			severity: domain.SeverityError,
			field:    "path",
			entity:   changeEntity(42, "widget", "docs/changes/active/0042-.md"),
		},
		{
			name: "filename slug truncated against a long frontmatter slug",
			...
			severity: domain.SeverityError,
			field:    "path",
			entity:   changeEntity(42, "widget-with-a-very-long-authored-slug", "docs/changes/active/0042-widget-with-a-very-long.md"),
		},
		{
			name: "filename matching the frontmatter identity exactly is no mismatch",
			docs: []InputDocument{record(t, KindChange, LocationActive, activePath,
				minimalChange(42, "widget", "proposed"))},
			code:   CodeChangeFilenameMismatch,
			absent: true,
		...
		{
			name: "ADR filename slug is a bare prefix of its frontmatter slug",
			docs: []InputDocument{record(t, KindADR, LocationLedger, "docs/adrs/0007-cho.md",
				minimalADR(7, "choice", "Accepted"))},
			code:     CodeADRFilenameMismatch,
			severity: domain.SeverityError,
			field:    "path",
			entity:   domain.EntityRef{Kind: domain.EntityADR, ID: 7, Slug: "choice", Path: "docs/adrs/0007-cho.md"},
		},
		{
			name: "ADR filename carries no slug at all",
			docs: []InputDocument{record(t, KindADR, LocationLedger, "docs/adrs/0007-.md",
				minimalADR(7, "choice", "Accepted"))},
			code:     CodeADRFilenameMismatch,
			severity: domain.SeverityError,
			field:    "path",
			entity:   domain.EntityRef{Kind: domain.EntityADR, ID: 7, Slug: "choice", Path: "docs/adrs/0007-.md"},
		},
		{
