...
var proseContracts = []proseContract{
	...
	// change 0425 supersedes change 0393's automatic root-entry route: all roles
	// use native dispatch and feature ownership comes from a checked assignment.
	{sentinel: "change_0393_feature_child_entry", file: "docs/reference/harness/validation-runbook.md",
		...
		absent: []string{"Feature-scoped ordinary child roles must enter through foreground `agent.enter`"}},
