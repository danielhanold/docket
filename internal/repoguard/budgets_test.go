...
var skillBudgets = []skillBudget{
	...
	{"docket-implement-next/SKILL.md", 214, 8233},                // 0448: +named-invocation branch and bounded own-dependency closeout (ceilings 210/7716 -> 214/8223 -> 214/8233); 0393: +exact payload, marker, and direct-dispatch lines atop 0410/0354/0376; 0375: +gate-epoch resume pointer (word ceiling 7530 -> 7547); 0440: reader-first results prose
