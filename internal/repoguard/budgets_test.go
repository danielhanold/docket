...
var skillBudgets = []skillBudget{
	...
	{"docket-groom-next/SKILL.md", 77, 1850},                         // 0445: +revise route for already-groomed explicit ids (Step 1) and the fifth Step-4 exit (word ceiling 1650 -> 1813); +spec_path/spec_version pin for a spec-body revise (1813 -> 1849); +revise spec_markdown excludes the backlink block (1849 -> 1850)
