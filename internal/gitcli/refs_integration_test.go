...
func TestIntegrationRepoRemoteDefaultBranchAsksRemote(t *testing.T) {
	requireGit(t)
	c := newRealClient(t)
...
// writer pushed one.
func TestIntegrationRepoFetchBranchTargetedUpdatesTrackingRef(t *testing.T) {
	requireGit(t)
	c := newRealClient(t)
	ctx := context.Background()
	r := newMainModeRepos(t)
...
// materializes.
func TestIntegrationRepoFetchBranchDoesNotFetchUnrelatedBranches(t *testing.T) {
	requireGit(t)
	c := newRealClient(t)
	ctx := context.Background()
	r := newMainModeRepos(t)
...
func TestIntegrationRepoResolveRefFoundAndNotFound(t *testing.T) {
	requireGit(t)
	c := newRealClient(t)
	ctx := context.Background()
	r := newMainModeRepos(t)
...
func TestIntegrationRepoRefsFailureKinds(t *testing.T) {
	requireGit(t)
	c := newRealClient(t)
	ctx := context.Background()
	r := newMainModeRepos(t)
...
func TestIntegrationRepoRemoteURLReturnsConfiguredURL(t *testing.T) {
	requireGit(t)
	c := newRealClient(t)
	ctx := context.Background()
	r := newMainModeRepos(t)
...
func TestIntegrationRepoRemoteURLUnconfiguredRemoteIsRemoteUnavailable(t *testing.T) {
	requireGit(t)
	c := newRealClient(t)
	r := newMainModeRepos(t)
	repo := mustDiscover(t, c, r.Invocation)
