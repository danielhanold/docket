...
func TestIntegrationRepoProbeRemoteBranchFoundReturnsExactID(t *testing.T) {
	requireGit(t)
...
func TestIntegrationRepoProbeRemoteBranchAbsent(t *testing.T) {
	requireGit(t)
	ctx := context.Background()
	c := newRealClient(t)
	r := newMainModeRepos(t)
...
func TestIntegrationRepoProbeRemoteBranchUnconfiguredRemoteErrorsNotAbsent(t *testing.T) {
	requireGit(t)
	ctx := context.Background()
	c := newRealClient(t)
	r := newMainModeRepos(t)
...
func TestIntegrationRepoProbeRemoteBranchMatchesExactRefNotPrefix(t *testing.T) {
	requireGit(t)
	ctx := context.Background()
	c := newRealClient(t)
	r := newMainModeRepos(t)
