...
> ↩ **[Change 0330 — Optional closeout notes preserve post-merge verification without rewriting frozen results](https://github.com/danielhanold/docket/blob/docket/docs/changes/active/0330-post-merge-results-appending-has-no-home-in-the-go-runtime-f.md)**
<!-- docket:backlink:end -->
