...
- **`.gitignore`**: add `.docket/` + `.worktrees/`. (The file already exists — currently just `.DS_Store`, per commit `b2a75ae` — so **extend** it, don't create.)
