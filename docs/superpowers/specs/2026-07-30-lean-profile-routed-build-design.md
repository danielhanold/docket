...
> ↩ **[Change 0167 — Lean profile-routed build — fresh task workers without review loops](https://github.com/danielhanold/docket/blob/docket/docs/changes/active/0167-lean-profile-routed-build.md)**
<!-- docket:backlink:end -->
