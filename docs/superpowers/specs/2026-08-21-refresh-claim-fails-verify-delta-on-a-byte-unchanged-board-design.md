...
> ↩ **[Change 0335 — refresh-claim fails verify-delta when the board is byte-unchanged](https://github.com/danielhanold/docket/blob/docket/docs/changes/active/0335-refresh-claim-fails-verify-delta-on-a-byte-unchanged-board.md)**
<!-- docket:backlink:end -->
