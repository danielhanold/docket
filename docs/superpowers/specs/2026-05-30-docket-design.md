...
docs/changes/
  ...
  archive/
    2026-05-30-0004-quicklook-extension.md   # YYYY-MM-DD-<id>-<slug>.md (date = merge-commit date in UTC for `done`, kill-commit date for `killed`)
