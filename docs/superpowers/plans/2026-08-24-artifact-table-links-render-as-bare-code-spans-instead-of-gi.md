...
> ↩ **Change 0341 — Artifact-table links render as bare code spans instead of GitHub links** — `docs/changes/active/0341-artifact-table-links-render-as-bare-code-spans-instead-of-gi.md`
<!-- docket:backlink:end -->
