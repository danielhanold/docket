...
This disposable Codex option-2 fixture uses native named-agent dispatch for the coordinator and feature children. Read the fixture .codex/POC-WORKTREE.md for explicit feature targeting and entry validation. No agent.enter or subprocess/root-entry adapter is permitted in this experiment. Other role behavior remains unchanged.
