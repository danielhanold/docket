...
| Artifact | Link |
|---|---|
| Plan | [2026-07-20-rename-docket-yml-example-to-docket-example-yml.md](https://github.com/danielhanold/docket/blob/docket/docs/superpowers/plans/2026-07-20-rename-docket-yml-example-to-docket-example-yml.md) |
| Results | [2026-07-20-rename-docket-yml-example-to-docket-example-yml-results.md](https://github.com/danielhanold/docket/blob/docket/docs/results/2026-07-20-rename-docket-yml-example-to-docket-example-yml-results.md) |
