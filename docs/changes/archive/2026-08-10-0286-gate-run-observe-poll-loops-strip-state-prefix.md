...
| Plan | [2026-08-10-gate-run-observe-poll-loops-strip-state-prefix.md](https://github.com/danielhanold/docket/blob/docket/docs/superpowers/plans/2026-08-10-gate-run-observe-poll-loops-strip-state-prefix.md) |
| Results | [2026-08-10-gate-run-observe-poll-loops-strip-state-prefix-results.md](https://github.com/danielhanold/docket/blob/docket/docs/results/2026-08-10-gate-run-observe-poll-loops-strip-state-prefix-results.md) |
