...
results: docs/results/2026-07-14-cwd-independent-repo-root-anchor-results.md
trivial: false
auto_groomable: false
branch: feat/cwd-independent-repo-root-anchor
pr: https://github.com/danielhanold/docket/pull/84
blocked_by:
reconciled: true
---
...
| Plan | [2026-07-14-cwd-independent-repo-root-anchor.md](https://github.com/danielhanold/docket/blob/docket/docs/superpowers/plans/2026-07-14-cwd-independent-repo-root-anchor.md) |
| Results | [2026-07-14-cwd-independent-repo-root-anchor-results.md](https://github.com/danielhanold/docket/blob/docket/docs/results/2026-07-14-cwd-independent-repo-root-anchor-results.md) |
