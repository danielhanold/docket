...
discovered_from: []
adrs: [19, 74, 102, 107, 111, 115, 116]
...
results: 'docs/results/2026-09-10-make-build-and-outer-run-gate-attempt-limits-configurable-results.md'
trivial: false
auto_groomable:
branch_prefix:
