...
| Plan | [2026-08-08-guard-the-config-suite-s-enumerated-claims-export-order-and.md](https://github.com/danielhanold/docket/blob/docket/docs/superpowers/plans/2026-08-08-guard-the-config-suite-s-enumerated-claims-export-order-and.md) |
| Results | [2026-08-09-guard-the-config-suite-s-enumerated-claims-export-order-and-results.md](https://github.com/danielhanold/docket/blob/docket/docs/results/2026-08-09-guard-the-config-suite-s-enumerated-claims-export-order-and-results.md) |
