...
| Plan | [2026-07-18-implement-next-loop-continuation.md](https://github.com/danielhanold/docket/blob/docket/docs/superpowers/plans/2026-07-18-implement-next-loop-continuation.md) |
| Results | [2026-07-18-implement-next-loop-continuation-results.md](https://github.com/danielhanold/docket/blob/docket/docs/results/2026-07-18-implement-next-loop-continuation-results.md) |
