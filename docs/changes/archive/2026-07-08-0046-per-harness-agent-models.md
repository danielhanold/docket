...
results: docs/results/2026-07-08-per-harness-agent-models-results.md
trivial: false
auto_groomable:
branch: feat/per-harness-agent-models
pr: https://github.com/danielhanold/docket/pull/56
blocked_by:
reconciled: true
---
...
| Plan | [2026-07-08-per-harness-agent-models.md](https://github.com/danielhanold/docket/blob/docket/docs/superpowers/plans/2026-07-08-per-harness-agent-models.md) |
| Results | [2026-07-08-per-harness-agent-models-results.md](https://github.com/danielhanold/docket/blob/docket/docs/results/2026-07-08-per-harness-agent-models-results.md) |
