...
| Results | [2026-07-27-cursor-agent-wrapper-contract-results.md](https://github.com/danielhanold/docket/blob/feat/cursor-agent-wrapper-contract/docs/results/2026-07-27-cursor-agent-wrapper-contract-results.md) |
