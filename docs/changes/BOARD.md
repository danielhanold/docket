...
|---|-------|----------|------|--------|
| [0037](active/0037-skill-fallback-progressive-disclosure.md) | Slim skills — move the per-skill manual-fallback / script-contract prose into on-demand sibling files | `medium` | [spec](../superpowers/specs/2026-06-21-skill-fallback-progressive-disclosure-design.md) | `feat/skill-fallback-progressive-disclosure` |
