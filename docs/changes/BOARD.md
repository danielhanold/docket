...
**439 changes** — 🟢 2 in progress · 🟣 3 groomed · 🟡 13 proposed · ⚪ 11 deferred · ✅ 291 done · 🗑️ 119 killed

## 🟢 In progress (2)

| # | Title | Priority | Type | Spec | Branch | Readiness |
|---|-------|----------|------|------|--------|-----------|
| [0418](active/0418-surface-every-unmet-repository-health-postcondition.md) | Surface every unmet repository health postcondition | `medium` | `fix` | [spec](../superpowers/specs/2026-09-20-surface-every-unmet-repository-health-postcondition-design.md) | `fix/surface-every-unmet-repository-health-postcondition` |  |
...
<details><summary>✅🗑️ Archive — done + killed (410)</summary>
