...
|---|-------|----------|------|-----------|
| [0416](active/0416-scoped-build-task-gate-starts-omit-prepared-scope-identity.md) | Scoped build-task gate starts omit prepared scope identity | `high` | `fix` | build-ready (trivial) |
