...
**442 changes** — 🟢 1 in progress · 🟣 4 groomed · 🟡 12 proposed · ⚪ 11 deferred · ✅ 295 done · 🗑️ 119 killed
...
|---|-------|----------|------|------|
| [0442](active/0442-rebase-again-when-main-advances-after-finalize-publishes.md) | Rebase again when main advances after finalize publishes | `medium` | `fix` | [spec](../superpowers/specs/2026-09-22-rebase-again-when-main-advances-after-finalize-publishes-design.md) |
