...
**325 changes** — 🟡 49 proposed · ⚪ 4 deferred · 🔵 1 implemented · ✅ 191 done · 🗑️ 80 killed
...
| [0315](active/0315-claim-to-implemented-workflow.md) | Claim-to-implemented agent workflow | `critical` | `feat` | ⏳ waiting on #314 — needs your merge |
...
|---|-------|----------|------|----|-----------|
| [0314](active/0314-native-process-supervisor-and-local-gate.md) | Native process supervisor and local gate | `critical` | `feat` | [#215](https://github.com/danielhanold/docket/pull/215) |  |
