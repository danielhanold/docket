...
**439 changes** — 🟢 1 in progress · 🔵 1 built · 🟣 3 groomed · 🟡 13 proposed · ⚪ 11 deferred · ✅ 291 done · 🗑️ 119 killed
...
|---|-------|----------|------|----|-------|
| [0418](active/0418-surface-every-unmet-repository-health-postcondition.md) | Surface every unmet repository health postcondition | `medium` | `fix` | [#319](https://github.com/danielhanold/docket/pull/319) | awaiting merge |
