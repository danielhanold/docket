...
**440 changes** — 🟢 1 in progress · 🟣 4 groomed · 🟡 12 proposed · ⚪ 11 deferred · ✅ 293 done · 🗑️ 119 killed
...
|---|-------|----------|------|------|
| [0440](active/0440-make-results-artifacts-readable-and-actionable.md) | Make results artifacts readable and actionable | `medium` | `refactor` | [spec](../superpowers/specs/2026-09-21-make-results-artifacts-readable-and-actionable-design.md) |
