...
**96 changes** — 🟡 11 proposed · 🔴 1 blocked · ⚪ 1 deferred · 🔵 5 implemented · ✅ 73 done · 🗑️ 5 killed
...
| [0087](active/0087-headless-finalize-driver.md) | Headless finalize — the finalize-side disposition contract, mirroring 0088 | `high` | needs-brainstorm |
...
<details><summary>✅🗑️ Archive — done + killed (78)</summary>
