...
**324 changes** — 🟢 1 in progress · 🟡 49 proposed · ⚪ 4 deferred · ✅ 190 done · 🗑️ 80 killed

## 🟢 In progress (1)

| # | Title | Priority | Type | Spec | Branch |
|---|-------|----------|------|------|--------|
| [0312](active/0312-planning-mutations-board-and-adrs.md) | Planning mutations, inline board, and ADRs | `critical` | `feat` | [spec](../superpowers/specs/2026-08-16-planning-mutations-board-and-adrs-design.md) | `feat/planning-mutations-board-and-adrs` |
