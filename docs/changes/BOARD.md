...
**81 changes** — 🟢 1 in progress · 🟡 11 proposed · 🔴 1 blocked · 🔵 2 implemented · ✅ 63 done · 🗑️ 3 killed

## 🟢 In progress (1)

| # | Title | Priority | Spec | Branch |
|---|-------|----------|------|--------|
| [0080](active/0080-link-skills-create-harness-dir.md) | link-skills.sh creates a missing skills subdir when the harness is present | `medium` | [spec](../) | `feat/link-skills-create-harness-dir` |
