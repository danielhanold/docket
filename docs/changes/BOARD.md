...
|---|-------|----------|------|----|-------|
| [0431](active/0431-native-codex-acceptance-for-active-worker-validation.md) | Native Codex acceptance for active worker validation | `low` | `chore` | [#309](https://github.com/danielhanold/docket/pull/309) | awaiting merge |
