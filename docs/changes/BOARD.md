...
**41 changes** — 🟢 1 in progress · 🟡 9 proposed · ✅ 30 done · 🗑️ 1 killed
...
| [0041](active/0041-post-merge-sync-targets-consuming-repo.md) | Post-merge integration sync fast-forwards the docket clone, not the consuming repo where the merge landed | `medium` | build-ready |
