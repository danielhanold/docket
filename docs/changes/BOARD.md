...
**439 changes** — 🟢 2 in progress · 🟣 3 groomed · 🟡 15 proposed · ⚪ 11 deferred · ✅ 289 done · 🗑️ 119 killed

## 🟢 In progress (2)

| # | Title | Priority | Type | Spec | Branch | Readiness |
|---|-------|----------|------|------|--------|-----------|
| [0439](active/0439-leaked-worktree-gate-admission-slot-stuck-in-executing-block.md) | Leaked worktree gate-admission slot stuck in "executing" blocks finalize.rebase with a swallowed unavailable error | `medium` | `fix` | [spec](../superpowers/specs/2026-09-20-leaked-worktree-gate-admission-slot-stuck-in-executing-block-design.md) | `fix/leaked-worktree-gate-admission-slot-stuck-in-executing-block` |  |
