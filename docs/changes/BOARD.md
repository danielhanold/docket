...
**21 changes** — 🟢 1 in progress · 🟡 6 proposed · ✅ 14 done

## 🟢 In progress (1)

| # | Title | Priority | Spec | Branch |
|---|-------|----------|------|--------|
| [0021](active/0021-finalize-consent-model.md) | Finalize consent model — ambiguity-only prompt + require_pr_approval policy gate | `medium` | [spec](../superpowers/specs/2026-06-17-finalize-consent-model-design.md) | `feat/finalize-consent-model` |
