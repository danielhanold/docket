...
**428 changes** — 🟢 2 in progress · 🟣 4 groomed · 🟡 24 proposed · ⚪ 11 deferred · ✅ 274 done · 🗑️ 113 killed
...
|---|-------|----------|------|-----------|
| [0428](active/0428-recover-legacy-gate-history-without-blocking-unrelated-workt.md) | Recover legacy gate history without blocking unrelated worktree admission | `critical` | `fix` | needs-brainstorm |
