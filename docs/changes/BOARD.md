...
**325 changes** — 🟢 1 in progress · 🟡 48 proposed · ⚪ 4 deferred · ✅ 192 done · 🗑️ 80 killed

## 🟢 In progress (1)

| # | Title | Priority | Type | Spec | Branch |
|---|-------|----------|------|------|--------|
| [0315](active/0315-claim-to-implemented-workflow.md) | Claim-to-implemented agent workflow | `critical` | `feat` | [spec](../superpowers/specs/2026-08-17-claim-to-implemented-workflow-design.md) | `feat/claim-to-implemented-workflow` |
