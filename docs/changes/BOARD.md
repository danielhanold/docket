...
**428 changes** — 🟢 3 in progress · 🟣 3 groomed · 🟡 20 proposed · ⚪ 11 deferred · ✅ 278 done · 🗑️ 113 killed
...
| [0422](active/0422-bind-outer-run-gate-retry-consumption-to-a-dispatch-epoch-no.md) | Bind outer run-gate retry consumption to a dispatch epoch, not each observation | `medium` | `chore` | [spec](../superpowers/specs/2026-09-15-bind-outer-run-gate-retry-consumption-to-a-dispatch-epoch-no-design.md) | `chore/bind-outer-run-gate-retry-consumption-to-a-dispatch-epoch-no` |  |
...
<details><summary>✅🗑️ Archive — done + killed (391)</summary>
