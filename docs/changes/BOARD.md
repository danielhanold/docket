...
**73 changes** — 🟢 1 in progress · 🟡 11 proposed · 🔵 2 implemented · ✅ 57 done · 🗑️ 2 killed
...
| [0071](active/0071-board-surfaces-unset-vs-empty.md) | Encode the disabled board positively — an empty surfaces value is a wiring bug, not a configuration | `medium` | ⏳ waiting on #72 — needs your merge |
| [0073](active/0073-cursor-sandbox-permissions-guide.md) | Cursor sandbox & permissions guide — copyable config, trust tiers, troubleshooting | `medium` | ⏳ waiting on #72 — needs your merge |
...
| [0072](active/0072-facade-skill-rewiring.md) | Rewire the operating skills and Step-0 to the facade — retire the eval preamble | `medium` | [#79](https://github.com/danielhanold/docket/pull/79) |
