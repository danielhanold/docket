...
**439 changes** — 🟢 2 in progress · 🟣 3 groomed · 🟡 12 proposed · ⚪ 11 deferred · ✅ 292 done · 🗑️ 119 killed

## 🟢 In progress (2)

| # | Title | Priority | Type | Spec | Branch | Readiness |
|---|-------|----------|------|------|--------|-----------|
| [0350](active/0350-surface-the-swallowed-validation-failure-behind-a-bare-inter.md) | Surface the swallowed validation failure behind a bare internal-error in the transaction engine | `medium` | `fix` | [spec](../) | `fix/surface-the-swallowed-validation-failure-behind-a-bare-inter` |  |
