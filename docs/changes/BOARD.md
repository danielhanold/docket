...
**142 changes** — 🟢 1 in progress · 🟡 23 proposed · 🔴 1 blocked · ⚪ 4 deferred · 🔵 2 implemented · ✅ 102 done · 🗑️ 9 killed

## 🟢 In progress (1)

| # | Title | Priority | Type | Spec | Branch |
|---|-------|----------|------|------|--------|
| [0115](active/0115-extend-the-board-row-dropped-invariant-to-archive-files.md) | Extend the board-row-dropped invariant to archive/ files | `medium` | `fix` | [spec](../superpowers/specs/2026-07-20-archive-side-row-dropped-invariant-design.md) | `feat/extend-the-board-row-dropped-invariant-to-archive-files` |
...
| [0120](active/0120-docket-finalize-change-claims-integration-branch-is-read-fro.md) | docket-finalize-change claims integration_branch is read from .docket.yml, but it is an exported resolver key | `medium` | `docs` | build-ready |
...
| [0130](active/0130-make-the-finalize-marker-reachability-guard-portable-to-bsd.md) | Make the finalize marker reachability guard portable to BSD grep | `medium` | `fix` | build-ready |
