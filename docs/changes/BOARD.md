...
**443 changes** — 🟢 2 in progress · 🟣 3 groomed · 🟡 12 proposed · ⚪ 11 deferred · ✅ 296 done · 🗑️ 119 killed

## 🟢 In progress (2)

| # | Title | Priority | Type | Spec | Branch | Readiness |
|---|-------|----------|------|------|--------|-----------|
| [0414](active/0414-results-placeholder-heuristic-false-positives-on-uppercase-h.md) | Results placeholder heuristic false-positives on uppercase HTML tags and URI schemes | `low` | `chore` | [spec](../superpowers/specs/2026-09-22-results-placeholder-heuristic-false-positives-on-uppercase-h-design.md) | `chore/results-placeholder-heuristic-false-positives-on-uppercase-h` |  |
