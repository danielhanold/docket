...
| [0334](active/0334-claude-md-global-and-project-copies-out-of-sync-on-finalize-a.md) | Consolidate the docket dispatch block — subagent guard + single per-repo source | `medium` | `fix` | build-ready |
...
<details><summary>✅🗑️ Archive — done + killed (292)</summary>
