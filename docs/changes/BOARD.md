...
**441 changes** — 🟢 1 in progress · 🟣 3 groomed · 🟡 13 proposed · ⚪ 11 deferred · ✅ 294 done · 🗑️ 119 killed
...
|---|-------|----------|------|-----------|
| [0441](active/0441-release-successful-implementation-ownership-before-standalon.md) | Release successful implementation ownership before standalone finalize | `high` | `fix` | needs-brainstorm |
